...
class A2Test {
	...
	void testDupCaps() {
		...
		assertEquals("AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz", A2.dupCaps("ABCDEFGHIJKLMNOPQRSTUVWXYZ"));
	}
	...
	void testNextLowerCase() {
		...
		assertEquals("bcdefghijklmnopqrstuvwxyza", A2.nextLowerCase("abcdefghijklmnopqrstuvwxyz"));
